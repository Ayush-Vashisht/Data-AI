      ...
      <div className="flex flex-col gap-6 text-white">
        <div className="flex items-start justify-between">
          <div className="flex gap-4">
            <Avatar className="h-16 w-16 text-purple-500">
          ...
          <div className="flex gap-2">
            <Badge variant="secondary">
              <div className="flex items-center gap-1 font-medium bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text ">
                <Share className="w-3 h-3 font-medium text-purple-500" />
          ...
          <div className="flex flex-wrap gap-2">
            {data.expertise.map((skill) => (
              <Badge key={skill} variant="secondary" className="font-medium ">
                <span className="flex items-center justify-between gap-1 font-medium bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-purple-500">
                {skill}</span>
              </Badge>
            ))}
          </div>
